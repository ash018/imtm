		...
		<!-- Top Bar -->
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <img src="<?php echo base_url() ?>assets/images/logo.png" alt="Smiley face" height="100" width="200">
...
<!--    <a class="navbar-brand" href="#">Navbar</a>-->
    ...
    <div class="collapse navbar-collapse" id="basicExampleNav">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">DIGITAL CONTENT</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">ALBUM</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#">JOB PLACEMENT</a>
            </li>
            <li class="nav-item">
...
<!--		<div class="search">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="#">STUDENT INFO</a></li>
				<li class="menu_mm"><a href="#">ACADEMICS</a></li>
                                <li class="menu_mm"><a href="#">DIGITAL CONTENT</a></li>
                                <li class="menu_mm"><a href="#">ALBUM</a></li>
                                <li class="menu_mm"><a href="#">JOB PLACEMENT</a></li>
		...
		<div class="container">
			...
			<div class="row team_row">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="<?php echo base_url()?>assets/images/team_1.jpg" alt=""></div>
						<div class="team_body">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="<?php echo base_url()?>assets/images/team_2.jpg" alt=""></div>
						<div class="team_body">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="<?php echo base_url()?>assets/images/team_3.jpg" alt=""></div>
						<div class="team_body">
				...
				<div class="col-lg-3 col-md-6 team_col">
					<div class="team_item">
						<div class="team_image"><img src="<?php echo base_url()?>assets/images/team_4.jpg" alt=""></div>
						<div class="team_body">
	...
	<div class="newsletter">
		<div class="newsletter_background parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url()?>assets/images/newsletter.jpg" data-speed="0.8"></div>
		<div class="container">
			<div class="row">
				<div class="col">
							...
							<div class="col-lg-3 footer_col clearfix">
								...
								<div class="footer_section footer_mobile">
									...
									<div class="footer_mobile_content">
										<div class="footer_image"><a href="#"><img src="<?php echo base_url()?>assets/images/mobile_1.png" alt=""></a></div>
										<div class="footer_image"><a href="#"><img src="<?php echo base_url()?>assets/images/mobile_2.png" alt=""></a></div>
									</div>
								</div>
