...
<!--                <div id="pagination">
    ...
    <div id="left-sidebar">
        <div class="widget">
            <h2>Student Info</h2>
            <ul>
                <li class="page_item page-item-161"><a href="<?php echo base_url('Menu/ShipBuildingStudentInfo')?>">Ship Building</a></li>
                <li class="page_item page-item-163 current_page_item"><a href="<?php echo base_url('Menu/MarineTechnologyStudentInfo')?>">Marine Technology</a></li>
